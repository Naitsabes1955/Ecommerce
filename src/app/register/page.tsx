          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-dark px-4 py-3 text-sm text-cream placeholder-muted/50 outline-none transition-all focus:border-gold/50 focus:ring-1 focus:ring-gold/30"
              />
            </div>
